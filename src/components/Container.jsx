...
class Container extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="container-fluid col-md-5 text-center bg-secondary py-4 rounded-top rounded-1" id="quote-box">
                <h3 className="text-center py-2 px-5" id="text">❝{quote}{requesting && <p>Loading...</p>}❞</h3>
